...
color:red;
	...
	<body>
<div>
        <g:form controller="person" align="center" ID="myform" action="update" method="post" nonvalidate="nonvalidate"> 
<div id="form-content">
           ...
           <tab9><span id=firstNameinfo>Please enter FirstName</span></tab9><br><br>
            ...
            <div class="fieldgroup">
            <tab5><input type="submit" ID="btnsave" value="Update" class="submit" /></tab5>
            </div>
